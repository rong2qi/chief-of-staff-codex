...
An already-approved direct nonvisual relay is an audit record, not a TODO item or a new request. Missing package evidence, preparation, and evidence collection stay Chief-owned until an exact reserved decision is identified.
